...
<h1>
	<a href="<c:url value="/" />">Spring MVC + Apache Solr</a>
</h1>
...
<div id="tabs">
	<ul>
		...
		<li><a href="<c:url value="/fileupload" />" title="fileupload">Upload
				files</a></li>
		<li><a href="<c:url value="/search" />" title="search">Search
				form</a></li>
	</ul>
	<div id="home">
		<h5>Welcome to the application. To start, click on the 'Upload
			files' tab to upload the .eml files and proceed to the search page.</h5><br/>
	</div>
</div>
								...
								function() {
									...
									$.ajax({
										...
										success : function(text) {
											MvcUtil.showSuccessResponse(text,
													link);
										},
										error : function(xhr) {
