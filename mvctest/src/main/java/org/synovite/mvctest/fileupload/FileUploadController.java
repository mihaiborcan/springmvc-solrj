...
/**
 * Controller that is mapped to the /fileupload view and handles file uploading
 * 
 * @author Mihai
 *
 */
...
public class FileUploadController {
    ...
    /**
     * Autowired FileUploadManager instance (actual implementation hidden)
     */
    ...
    /**
     * Sends the uploaded files to the Solr server to be indexed, via autowired bean fileUploadManager.
     * Checks if no files have been selected or if files other than .eml were uploaded.
     * 
     * @param filesUploaded
     * @param model
     */
